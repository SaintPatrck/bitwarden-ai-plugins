...
| [bitwarden-delivery-tools](plugins/bitwarden-delivery-tools/)       | 2.3.0   | Delivery lifecycle skills: initiative funnel navigation, work transitions, tech breakdowns and task decomposition, commits, PRs, preflight, labeling        |
