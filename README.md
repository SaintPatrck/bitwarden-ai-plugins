...
| [bitwarden-code-review-tools](plugins/bitwarden-code-review-tools/)               | 2.0.3   | Autonomous code review agent following Bitwarden engineering standards with GitHub integration                                                                                    |
| [bitwarden-code-contribution-tools](plugins/bitwarden-code-contribution-tools/)   | 4.1.2   | Getting a change into a Bitwarden repository: commits, PRs, change labeling, preflight quality gates, addressing review feedback, and fleet-wide fan-out                          |
...
| [bitwarden-claude-config-tools](plugins/bitwarden-claude-config-tools/)           | 2.0.3   | Validates Claude Code configuration files for security, structure, and quality                                                                                                    |
