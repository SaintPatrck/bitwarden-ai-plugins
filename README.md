...
| [bitwarden-product-design-tools](plugins/bitwarden-product-design-tools/)         | 0.3.2   | Design toolkit: content style guide, Figma Dev Mode MCP, Bitwarden brand application, handoff prep, Design System governance, Product and Design Jira, design critique            |
