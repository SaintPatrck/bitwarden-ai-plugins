...
Shape references for the `Tech Breakdown` field on a task entry. Use these as a guide for what good code-first content looks like; do not copy verbatim.

## An entry touching a C# enum
...
## An entry adding a controller dispatch
...
## An entry adding a TypeScript handler branch
