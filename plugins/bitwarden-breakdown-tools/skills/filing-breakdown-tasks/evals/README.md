...
- `bitwarden-breakdown-tools` — supplies `filing-breakdown-tasks` itself. Without it the skill isn't in the session at all and every should-trigger query scores zero.
