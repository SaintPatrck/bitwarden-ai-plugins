...
- Initial release of this plugin. All 7 skills (including `managing-workflow-secrets`) moved in from `bitwarden-devops-engineer`, which continues to exist as a dependency-only bundle.
