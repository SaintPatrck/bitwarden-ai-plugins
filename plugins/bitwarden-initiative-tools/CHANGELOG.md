...
- Bare `Skill(architecting-solutions)` references across five skills, pointing at a skill owned by `bitwarden-architecture-tools`. Cross-plugin references must be qualified with the owning plugin's name.
