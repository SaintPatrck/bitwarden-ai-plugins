...
All notable changes to the `bitwarden-retrospective-tools` plugin will be documented in this file.
...
- Renamed from `claude-retrospective`. The README H1 and this changelog's header still named the old plugin.
