...
All notable changes to the `bitwarden-security-tools` plugin will be documented in this file.
...
- Changelog header named `bitwarden-security-engineer`, copied over when this plugin's skills moved in from that bundle. Now names this plugin.
...
- Initial release of this plugin. All 9 skills moved in from `bitwarden-security-engineer`, which continues to exist as a dependency-only bundle.
