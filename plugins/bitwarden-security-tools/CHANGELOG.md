...
- Renamed from `bitwarden-security-engineer`. Capability plugins are named for their domain, not a job title; the `bitwarden-security-engineer` slug is now the role bundle.
